...
class S(BaseHTTPRequestHandler):
    ...
    def create_timestamped_logs(self, timestamp):
        ...
        subprocess.run("mv /source/server/results.xml {}".format(timestamp['xml_route']), shell=True)
        # subprocess.run("mv /source/server/results.csv {}".format(timestamp['csv_route']), shell=True)
